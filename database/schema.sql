...
CREATE TABLE IF NOT EXISTS `propostas` (
    ...
    `indicado_por_vendedor_id` INT UNSIGNED DEFAULT NULL,
    `empresa_id`           INT UNSIGNED  DEFAULT NULL,
    `operadora_id`         INT UNSIGNED  NOT NULL,
    ...
    `origem`               ENUM('VENDEDOR','AUTOSSERVICO') NOT NULL DEFAULT 'VENDEDOR',
    ...
    INDEX `idx_indicado_por_vendedor` (`indicado_por_vendedor_id`),
    INDEX `idx_empresa`  (`empresa_id`),
    INDEX `idx_status`   (`status`),
    ...
    CONSTRAINT `fk_proposta_indicado_vendedor` FOREIGN KEY (`indicado_por_vendedor_id`) REFERENCES `vendedores` (`id`) ON DELETE SET NULL,
